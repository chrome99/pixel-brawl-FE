...
function App () {
  ...
  return (
    <div id="game">
      ...
      <Mage num={1} initPosition={{ top: 275, left: 850 }} initDirection={-1} addCol={addCol} deleteCol={deleteCol} updateColPosition={updateColPosition} playerStats={playerStats} updateStats={updateStats} />
      {colObjects.map((col) => {
        switch (col.type) {
          case "actor":
